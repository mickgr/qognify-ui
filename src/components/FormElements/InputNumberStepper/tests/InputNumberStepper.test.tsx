...
import { StyledInputNumberStepperMinus, StyledInputNumberStepperPlus } from '../InputNumberStepperStyles';
...
describe('input number stepper tests', () => {
	...
	it('should render default input number stepper with undefined minValue', () => {
		const wrapper = shallow(<InputNumberStepper {...props} minValue={undefined}/>);
