...
const StyledIconInputButton = styled.input`
    display: none;
`;
const StyledIconInputButtonLabel = styled.label<{ disabled?: boolean; error?: boolean }>`
    display: flex;
    flex-direction: row;
    align-items: center;
...
export { StyledIconInputButtonLabel, StyledIconInputButton, StyledBoldTitle, StyledTooltipDiv, StyledEllipsisText };
