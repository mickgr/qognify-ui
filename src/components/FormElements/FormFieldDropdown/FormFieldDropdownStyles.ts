...
const commonLabelStyle = css<{ disabled?: boolean; small?: boolean; medium?: boolean; matchParent?: boolean }>`
    ...
    width: ${(props): string =>
        props.small ? '150px' : props.medium ? '210px' : props.matchParent ? '100%' : '495px'};
    margin: 8px 0;
