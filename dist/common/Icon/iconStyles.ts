...
export const StyledArrowIcon = styled.div<{ isPointedUp?: boolean; fillColor?: string }>`
    svg {
        path {
            fill: ${(props): string => (props.fillColor ? props.fillColor : styles.color.shade.DARK)};
        }
        margin-left: 12px;
...
export const Svg = styled.svg.attrs<{ boxSize?: boxSizeType; viewBox?: string }>(
